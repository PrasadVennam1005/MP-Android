...
class SavingGoalViewModelTest {
    private val repository = mock(GoalRepository::class.java)
    ...
    @Test
    fun testSaveSavingGoalNewNotCompleted() =
        runTest {
    ...
    @Test
    fun testSaveSavingGoalNewCompleted() =
        runTest {
            val viewModel = SavingGoalViewModel(repository)
            val goal =
                SavingGoal(
    ...
    @Test
    fun testSaveSavingGoalExisting() =
        runTest {
            val viewModel = SavingGoalViewModel(repository)
            val goal =
                SavingGoal(
