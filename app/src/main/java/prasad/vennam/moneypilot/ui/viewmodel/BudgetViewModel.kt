...
class BudgetViewModel @Inject constructor(
    ...
    val budgetProgresses: StateFlow<List<BudgetProgress>> = combine(
        repository.allBudgets,
        repository.allCategories,
        repository.allTransactions,
        exchangeRateRepo.allRates,
        userPreferences.currency
    ) { budgets: List<prasad.vennam.moneypilot.data.entity.Budget>, categories: List<prasad.vennam.moneypilot.data.entity.Category>, transactions: List<prasad.vennam.moneypilot.data.entity.Transaction>, rates: Map<String, Double>, currentCurrency: String ->
        ...
        budgets.map { budget ->
            ...
            prasad.vennam.moneypilot.ui.viewmodel.BudgetProgress(budget, category, spent, budgetConverted, progress)
        }
    }.stateIn(viewModelScope, SharingStarted.WhileSubscribed(5000), emptyList())
