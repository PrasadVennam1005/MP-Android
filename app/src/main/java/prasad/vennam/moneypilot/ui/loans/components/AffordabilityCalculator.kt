...
@Composable
private fun AffordabilityMetric(
    label: String,
    value: String,
    modifier: Modifier,
) {
...
val ColorScheme.info: androidx.compose.ui.graphics.Color get() =
    androidx.compose.ui.graphics
        .Color(0xFF0288D1)
val ColorScheme.infoContainer: androidx.compose.ui.graphics.Color get() =
    androidx.compose.ui.graphics
        .Color(0xFFE1F5FE)
