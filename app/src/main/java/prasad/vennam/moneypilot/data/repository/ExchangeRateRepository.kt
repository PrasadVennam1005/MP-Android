...
class ExchangeRateRepository @Inject constructor(
    ...
    val allRates: Flow<Map<String, Double>> = exchangeRateDao.getAllRates().map { list ->
    ...
    suspend fun getRateForCurrency(code: String): Double {
        return exchangeRateDao.getRate(code) ?: 1.0
    }
}
